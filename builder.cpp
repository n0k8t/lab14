...
int main(int argc, char *argv[])
{
    ...
    if(vm.count("help")) {
        ...
        if (!res) res = Build().exit_code();
        if (!res) res = Target("install").exit_code();
        if (!res) res = Target("pack").exit_code();
        ...
        if (!res) res = Build().exit_code();
        if (!res) res = Target("package").exit_code();
        ...
        if (!res) res = Build(tim).exit_code();
